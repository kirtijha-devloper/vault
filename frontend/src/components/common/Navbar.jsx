...
const Navbar = ({ toggleSidebar, searchQuery, setSearchQuery }) => {
  ...
  return (
    <header className="h-16 bg-white dark:bg-[#111827] border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-6 sticky top-0 z-10 transition-colors">
      ...
      <div className="flex items-center gap-4 flex-1 max-w-xl">
        ...
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Search vault items by title, website, or username..."
            value={searchQuery}
